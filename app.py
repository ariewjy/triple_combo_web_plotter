...
with data_setting:
  ...
  res_left = st.sidebar.number_input('Resistivity Left Scale', min_value=0.00001, max_value=1000000.000)
  res_right = st.sidebar.number_input('Resistivity Right Scale', min_value=0.00001, max_value=1000000.000)
